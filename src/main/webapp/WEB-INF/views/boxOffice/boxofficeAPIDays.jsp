...
<body class="main-layout inner_page">
				...
				<div class="col-md-9 col-sm-9">
					...
					<div class="collapse navbar-collapse" id="navbarsExample04">
						...
						<ul class="email text_align_right">
							...
							<li><a class="search-switch" href="Javascript:void(0)">
					...
					<c:if
						...
						<c:forEach
							...
							<tr>
								...
								<td><fmt:formatNumber value="${boxoffice.salesAmt }"
										pattern="###,###,###,###" /></td>
								<td><c:out value="${boxoffice.salesShare }" /></td>
								<td><fmt:formatNumber value="${boxoffice.salesInten }"
										pattern="###,###,###,###" />/<c:out
										value="${boxoffice.salesChange }" /></td>
								<td><fmt:formatNumber value="${boxoffice.salesAcc }"
										pattern="###,###,###,###" /></td>
								<td><fmt:formatNumber value="${boxoffice.audiCnt }"
										pattern="###,###,###,###" /></td>
								<td><fmt:formatNumber value="${boxoffice.audiInten }"
										pattern="###,###,###,###" />/<c:out
										value="${boxoffice.audiChange }" /></td>
					...
					<div class="row">
						<div class="col-md-6 offset-md-3">
							<form action="" class="centered-form text-center"
								...
								<div class="form-group">
									<input type="submit" name="" class="read_more btn btn-primary"
										value="조회">
								</div>
							</form>
						</div>
					...
					<div class="Informa conta">
						...
						<ul>
							<li><a href="Javascript:void(0)"> <i
									class="fa fa-map-marker" aria-hidden="true"></i> Location
							</a></li>
							<li><a href="Javascript:void(0)"><i class="fa fa-phone"
									aria-hidden="true"></i> Call +01 1234567890 </a></li>
							<li><a href="Javascript:void(0)"> <i
									class="fa fa-envelope" aria-hidden="true"></i> demo@gmail.com
							</a></li>
						</ul>
					</div>
				</div>
	...
	<script>
		function fetchData() {
			...
			currentDate.setDate(currentDate.getDate() - 1); // 하루 전 날짜
			...
			if (inputDate < currentDate) {
				...
				// 오늘 날짜 포함해서 이후인 경우
				alert("오늘 날짜 기준으로 하루 전 데이터가 최신 데이터입니다. 다시 입력해주세요. ex) 20230101");
				return false; // 조회 취소
			}
		}
	</script>
